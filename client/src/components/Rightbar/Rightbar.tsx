...
export const Rightbar = () => {
  ...
  return (
    <div className='w-1/4 lg:w-[200px] lg:max-w-[290px] 2xl:max-w-[360px] xl:w-[360px] max-w-[360px] hidden md:block fixed right-2 overflow-y-scroll overflow-x-hidden'>
