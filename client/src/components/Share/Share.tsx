  ...
  return (
    <div className='w-full bg-white px-4 py-3 sm:rounded-lg shadow-sm shadow-gray-300'>
      <div className='flex gap-2'>
        ...
        <div className='bg-gray-light text-lg w-full text-gray-dark h-10 flex items-center px-3 rounded-full cursor-pointer hover:bg-gray-200 active:bg-gray-300'>
